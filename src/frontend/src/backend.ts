...
export class Backend implements backendInterface {
    ...
    async deleteMultipleOrders(arg0: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteMultipleOrders(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDeliveredOrders(): Promise<Array<OrderDTO>> {
        if (this.processError) {
            try {
    ...
    async getOrderById(arg0: bigint): Promise<OrderDTO> {
        if (this.processError) {
            try {
    ...
    async getPendingOrders(): Promise<Array<OrderDTO>> {
        if (this.processError) {
            try {
    ...
    async markOrderAsDelivered(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: OrderDTO): Promise<bigint> {
        if (this.processError) {
            try {
